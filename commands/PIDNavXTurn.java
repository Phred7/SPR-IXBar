...
public class PIDNavXTurn extends Command {
	...
	protected void execute() {
		...
		//SmartDashboard.putNumber("angle change?", (Robot.navX.getDeltaYaw()));/*Robot.navX.getNavXAngle()+Robot.navX.getNavXAngleChange()));*/
		...
		Robot.driveWC.driveR(-(speed));// changed this speed to -
